...
public class Appavancereto {
    ...
    public static void seleccionarNave() {
        System.out.println("\nEstas son las  tres naves espaciales disponibles para el viaje:");
        ...
        if (opcionNave >= 1 && opcionNave <= naves.length) {
            ...
            System.out.println(
                    "Ustede decidió viajar en la nave: " + naveSeleccionada + "  que maneja una  una velocidad de "
